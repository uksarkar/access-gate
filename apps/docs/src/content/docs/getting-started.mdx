...
**_@gate/js_** makes it easy to define, manage, and evaluate role-based access control (RBAC) in your applications. Follow these steps to get started:
...
## Basic Usage
To start using **_@gate/js_**, you need to create a Gate instance, define policies, and evaluate decisions.
```ts
